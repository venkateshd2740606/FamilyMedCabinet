#!/usr/bin/env python3
"""Generate FamilyMedCabinet Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\FamilyMedCabinet")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "familymedcabinet"
TEST = APP / "src" / "test" / "java" / "com" / "familymedcabinet"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "familymedcabinet"
...
rootProject.name = "FamilyMedCabinet"
include(":app")
'''
...
android {
    namespace = "com.familymedcabinet"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.familymedcabinet.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.familymedcabinet.data.** { *; }
-keep class com.familymedcabinet.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "familymedcabinet-game",
    "storage_bucket": "familymedcabinet-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.familymedcabinet.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating FamilyMedCabinet project files...")
