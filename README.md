...
1. Open `D:\Work\Games\FamilyMedCabinet` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `FamilyMedCabinetEngine.kt` (tube pour logic) and update the game board UI component.
