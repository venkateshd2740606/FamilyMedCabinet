# FamilyMedCabinet — Google Play Data Safety Form Reference
...
- **Users can request deletion:** Contact privacy@familymedcabinet.game; local data cleared via app settings or uninstall
